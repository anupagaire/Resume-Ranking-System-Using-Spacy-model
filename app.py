...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.f9wiu.mongodb.net/ResumeRanking'
#yo chai shristi ko db

# app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.mnbhd.mongodb.net/ResumeRanking'
...
def viewdetails():      
    ...
    if skill_resume is not None:
        ...
        skills = None
    return jsonify({'name':name,'linkedin_link':linkedin_link,'skills':skills})
